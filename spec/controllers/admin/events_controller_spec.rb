...
describe Admin::EventsController do
  ...
  describe "GET index" do
    it "assigns all admin_events as @admin_events" do
      ...
      assigns(:admin_events).should eq([event])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested admin_event as @admin_event" do
      ...
      assigns(:admin_event).should eq(event)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new admin_event as @admin_event" do
      ...
      assigns(:admin_event).should be_a_new(Admin::Event)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Admin::Event" do
        expect {
          post :create, {:admin_event => valid_attributes}, valid_session
        }.to change(Admin::Event, :count).by(1)
      end

      it "assigns a newly created admin_event as @admin_event" do
        post :create, {:admin_event => valid_attributes}, valid_session
        assigns(:admin_event).should be_a(Admin::Event)
        assigns(:admin_event).should be_persisted
      end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved admin_event as @admin_event" do
        ...
        Admin::Event.any_instance.stub(:save).and_return(false)
        post :create, {:admin_event => {}}, valid_session
        assigns(:admin_event).should be_a_new(Admin::Event)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested admin_event" do
        event = Admin::Event.create! valid_attributes
        # Assuming there are no other admin_events in the database, this
        # specifies that the Admin::Event created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Admin::Event.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, {:id => event.to_param, :admin_event => {'these' => 'params'}}, valid_session
      end

      it "assigns the requested admin_event as @admin_event" do
        event = Admin::Event.create! valid_attributes
        put :update, {:id => event.to_param, :admin_event => valid_attributes}, valid_session
        assigns(:admin_event).should eq(event)
      end
    ...
    describe "with invalid params" do
      it "assigns the admin_event as @admin_event" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Admin::Event.any_instance.stub(:save).and_return(false)
        put :update, {:id => event.to_param, :admin_event => {}}, valid_session
        assigns(:admin_event).should eq(event)
      end
